...
describe("GithubService", () => {
  ...
  // it(`should fetch posts as an Observable`, inject(
  //   [HttpTestingController, GithubService],
  //   (httpClient: HttpTestingController, githubService: GithubService) => {
  //     const postItem = [
  //       {
  //         id: 152756770,
  ...
  //           followers_url:
  //             "https://api.github.com/users/ilyamanuylovfe/followers",
  //           following_url:
  ...
  //           organizations_url:
  //             "https://api.github.com/users/ilyamanuylovfe/orgs",
  ...
  //         fork: true,
  //         url:
  //           "https://api.github.com/repos/ilyamanuylovfe/bootstrap-datepicker",
  //         forks_url:
  ...
  //         clone_url:
  //           "https://github.com/ilyamanuylovfe/bootstrap-datepicker.git",
  ...
  //         forks_url:
  //           "https://api.github.com/repos/ilyamanuylovfe/react-app/forks",
  //         keys_url:
  ...
  //         teams_url:
  //           "https://api.github.com/repos/ilyamanuylovfe/react-app/teams",
  //         hooks_url:
  //           "https://api.github.com/repos/ilyamanuylovfe/react-app/hooks",
  //         issue_events_url:
  ...
  //         tags_url:
  //           "https://api.github.com/repos/ilyamanuylovfe/react-app/tags",
  //         blobs_url:
  ...
  //     githubService.fetchUser().then((posts: any) => {
  //       console.log(posts);
  //       expect(posts.length).toBe(3);
  //     });

  //     let req = httpMock.expectOne(
  //       "https://api.github.com/users/ilyamanuylovfe/repos"
  //     );
